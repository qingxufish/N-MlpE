...
class ALL_ConvE(BaseModel):
    def __init__(self, config):
        super(ALL_ConvE, self).__init__(config)
        ...
        self.out_size = torch.tensor(kwargs.get('out_size'))
        ...
        fc_length = torch.sum(self.out_size**3)*self.conv_out_channels
